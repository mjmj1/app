...
const diretory = fs.existsSync("./workspace/images");
if (!diretory) fs.mkdirSync("./workspace/images");
...
app.use(express.static(__dirname + "/workspace/images"));
...
app.post("/upload-multiple", upload.array("imgUp", 5), (req, res) => {
    ...
    for (let i = 0; i < req.files.length; i++) {
        ...
        app.get(`/img${i + 1}`, (req, res) => {
            ...
            console.log(__dirname + urlArr[i]);
        });
    }
    res.redirect("/");
});
